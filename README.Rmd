...
--- 
For users with the newest package version, there is an added dependency on [`censable`](https://www.christophertkenny.com/censable/), which allows for an easier workflow. If you've used the `add_pmmf*_path()` workflow suggested, you don't even need to supply the paths!
